...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_n_limit', type=int, default=0,
                        help='Limit indexing to the first N selected instances. 0 means no limit.')
    ...
    if args.eval_n_limit:
        repo_folders = repo_folders[:args.eval_n_limit]
        print(f'Limiting graph index generation to first {len(repo_folders)} instances.')
